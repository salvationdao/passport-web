...
export const StoreItemAttibutes = (storeItem: StoreItem): Attribute[] => {
	...
	result.push({ trait_type: "Max Structure Hit Points", value: storeItem.data.blueprint_chassis.max_hitpoints })
	result.push({ trait_type: "Max Shield Hit Points", value: storeItem.data.blueprint_chassis.max_shield })
	result.push({ trait_type: "Name", value: storeItem.data.template.label })
	result.push({ trait_type: "Speed", value: storeItem.data.blueprint_chassis.speed })
	result.push({ trait_type: "Weapon Hardpoints", value: storeItem.data.blueprint_chassis.weapon_hardpoints })
	result.push({ trait_type: "Turret Hardpoints", value: storeItem.data.blueprint_chassis.turret_hardpoints })
	result.push({ trait_type: "Utility Slots", value: storeItem.data.blueprint_chassis.utility_slots })
	result.push({ trait_type: "Shield Recharge Rate", value: storeItem.data.blueprint_chassis.shield_recharge_rate })
