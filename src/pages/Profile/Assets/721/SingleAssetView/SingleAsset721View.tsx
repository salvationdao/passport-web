...
export const AssetView = ({
    ...
    const Buttons = useMemo(() => {
        ...
        return (
            <>
                {!showStake && (
                    <FancyButton startIcon={<ArrowForwardSharpIcon/>} disabled={locked} size="small"
                ...
                {showStake && (
                    <FancyButton startIcon={<ArrowDownwardSharpIcon/>} disabled={locked} size="small"
                ...
                {showUnstake && (
                    <FancyButton startIcon={<ArrowUpwardSharpIcon/>} disabled={locked} size="small"
                ...
                {showMint && (
                    <FancyButton startIcon={<ArrowUpwardSharpIcon/>} disabled={locked} size="small"
                                 onClick={() => setMintWindowOpen(true)}>
                        Transition Off-world {locked && "(Locked)"}
                    </FancyButton>
                )}
            </>
                    ...
                    >
                        ...
                        >
                            ...
                            <Stack spacing=".5rem" alignItems="flex-start">
                                <FancyButton
                                    size="small" onClick={refreshMetaData}
