...
export const AssetView = ({
	...
	return (
		<>
			...
			{provider && userAsset && (
				<StakeModal collection={collection} open={stakeModalOpen} asset={userAsset} reloadAsset={loadAsset} onClose={() => setStakeModalOpen(false)} />
			)}

			{provider && userAsset && (
				<UnstakeModal collection={collection} open={unstakeModalOpen} asset={userAsset} reloadAsset={loadAsset} onClose={() => setUnstakeModalOpen(false)} />
			)}
