...
import { DepositTransactionEntryProps, DepositTransactionTableProps } from "./AssetDepositDesktopTransactionTable"
import { colors } from "../../../theme"

export const AssetDepositMobileTransactionTable = ({ transactions }: DepositTransactionTableProps) => {
	return (
		<Box>
			<Box
				sx={{
	...
	return (
		<EntryBox>
			...
			<EntryDataRow>
				...
				<EntryData>x{entry.amount}</EntryData>
			</EntryDataRow>
			<EntryDataRow>
