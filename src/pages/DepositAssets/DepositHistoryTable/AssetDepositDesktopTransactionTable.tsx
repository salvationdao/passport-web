...
export const AssetDepositDesktopTransactionTable = ({ transactions }: DepositTransactionTableProps) => {
	return (
		<Box
			component="table"
			sx={{
		...
		>
			<EntryHeader>
				<EntryRow>
					...
					<th align="right">Collection Name</th>
...
export interface DepositTransactionEntryProps {
	transaction: AssetDepositTransaction
}
...
const DepositTransactionEntry = ({ transaction: entry }: DepositTransactionEntryProps) => {
	return (
		...
		>
			...
			<td align="right">
				<EntryData variant="caption">x{entry.amount}</EntryData>
			</td>
			<td align="right">
				<EntryData variant="caption">{entry.collection_name}</EntryData>
			</td>
			<td align="right">
				<EntryData variant="caption">{entry.token_id}</EntryData>
			</td>
			<td align="center">
